...
func (r ApiGetSettingRequest) Execute() (Setting, *_nethttp.Response, error) {
	return r.ApiService.GetSettingExecute(r)
}

/*
 * GetSetting Retrieve the setting with the given id
...
func (a *SettingsApiService) GetSettingExecute(r ApiGetSettingRequest) (Setting, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/settings/{id}"
