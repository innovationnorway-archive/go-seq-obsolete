...
func (r ApiDowngradeLicenseRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.DowngradeLicenseExecute(r)
}

/*
 * DowngradeLicense Remove the current license, causing the server to fall back to the default configuration.
